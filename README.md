...
| 🟦 **프로필** | 프로필 텍스트 변경 | 🟡 **이재석** | 프로필 내용(닉네임, 소개, 성별 등)텍스트를 만들 수 있다. |
| 🟦 **프로필** | 계정 공개 범위 변경 | 🟡 **이재석** | 계정 공개 범위 변경 가능하다. |
| 🟦 **프로필** | 게시물 노출 | 🟡 **이재석** | 내가 올린 게시물들이 모여져 노출되어 있다. (게시일시 내림차순) |
...
| 🟥 **댓글** | 댓글 수정 | 🔵 **장기현** | 댓글을 수정할 수 있으며, 수정 이력이 남는다. (수정됨) |
| 🟥 **댓글** | 댓글 삭제 | 🔵 **장기현** | 댓글을 삭제할 수 있다. |
