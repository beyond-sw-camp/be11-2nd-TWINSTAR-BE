 ...
 **[기본에 집중한 SNS 서비스]** </br></br>
  사용자들의 관심사와 취향을 중심으로 친밀하고 진정성 있는 관계 형성을 지원하는 맞춤형 소셜 네트워크 서비스(SNS)입니다. 트윈스타는 기존의 유명인 중심이나 표면적인 소통에서 벗어나 개인의 취향과 관심사에 맞는 콘텐츠를 공유하고, 이를 통해 의미 있고 깊이 있는 인간관계를 구축할 수 있는 플랫폼을 제공하는 것을 목표로 합니다.
 <br>
...
## 3. 프로젝트 배경 및 필요성
 ### 3-1. 우리끼리 더 친밀해지는 트윈스타(Twinstar)
  최근 SNS는 사람들 간의 소통과 정보 교류에 있어 필수적인 플랫폼으로 자리 잡았습니다. 기존 SNS는 사용자의 관심사보다는 유명인이나 인플로언서 중심의 콘텐츠가 주를 이루고 있어서 일상적이고 친밀한 관계를 맺을 수 있는 새로운 형태의 SNS가 필요하다고 느껴졌습니다.
 
 ### 3-2. 트윈스타의 목표
  소중한 사람끼리 자신의 일상을 보여주는, 진정성 있는 관계형성과 의미 있는 콘텐츠 공유를 경험할 수 있을 것입니다.
